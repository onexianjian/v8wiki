...
If you get an email, that the [Node integration build](https://build.chromium.org/p/client.v8.fyi/builders/V8%20-%20node.js%20integration) fails with your V8 CL, there is either a legitimate problem with your CL (you should revert the CL and fix it) or [Node](https://github.com/v8/node/) must be modified. **This document describes how to reproduce the problem locally and how to make changes to ****[V8’s Node for**k](https://github.com/v8/node/)** if your V8 CL causes the build to fail.**

*Note: Patches in V8’s fork are usually cherry-picked by the person who updates V8 in **[Nod*e](https://github.com/nodejs/node)* (usually several weeks or month later). If you merged a fix to V8’s Node fork, there’s nothing else you need to do.*
